...
const projects = [
  ...
  overview: "A modular, customizable frame system designed for maximum versatility, accessibility, and market scalability. It allows seamless swapping of sections to create different frame sizes and styles, while addressing challenges faced by families, frequent movers, and individuals with mobility or fine motor limitations.",
  problem: "How can the team incorporate new materials, mechanisms, and personalization to improve the user experience and accessibility of picture frames?",
...
},
  {
    ...
    overview: "Eventure is a mobile app designed to help users seamlessly discover, plan, and engage with local events — both organized events from businesses and casual hangouts with friends. Built around a persona-driven design process, it focuses on connecting communities while keeping the interface simple and clutter-free.",
    problem: "Existing event discovery apps either cater to large formal events or informal social plans — never both. Users had no single place to see what friends were doing nearby, discover local events, and create their own hangouts without switching between multiple apps.",
    process: "I started with user personas and mapped out the core user flows before designing any screens. The key insight was that users needed two distinct modes — organized events and general hangouts — with a shared interface. I designed the navigation around a bottom tab bar for consistency, with map-first exploration as the primary entry point.",
    outcome: "A full wireframe covering 15+ screens including home, map exploration, search, event detail, create event, profile, and settings. The design prioritizes social context — showing who you know at each event — to reduce friction in deciding whether to attend.",
    screens: [
  ...
  { src: '/Eventure/eventure-settings.png', label: 'Settings' },
    ...
    takeaway: "This project deepened my understanding of user-centric design by combining research, prototyping, and usability testing. The biggest lesson was designing for social context — people don't just want to find events, they want to know who else will be there.",
